...
const Header = () => {
  ...
  return (
    <>
      <header className="bg-purple text-white navbar navbar-expand-md navbar-dark d-print-none">
        <div className="container-xl">
          ...
          <h1 className="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <Link to="/">
              <img
                src="https://logos.textgiraffe.com/logos/logo-name/Anjani-designstyle-kiddo-m.png"
                width="110"
                height="32"
                alt="Tabler"
